...
namespace TaskManagement.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarUrl", "CreatedAt", "Email", "ExternalAuthId", "FullName", "PasswordHash", "Status", "UpdatedAt" },
                values: new object[] { new Guid("8a4b4ef9-7ec7-4dbb-8fb6-82ff4b4ab456"), null, new DateTime(2026, 7, 7, 0, 0, 0, 0, DateTimeKind.Utc), "admin@taskmanagement.com", null, "Administrator", "$2a$11$qRz3vYmK3e4e9Fh6z82sNu98c5C6z7b6O8y/eW5G42e9X2aO1q9i.", "Active", new DateTime(2026, 7, 7, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { 1, new Guid("8a4b4ef9-7ec7-4dbb-8fb6-82ff4b4ab456") });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Tasks",
                column: "DueDate",
                filter: "[IsDeleted] = 0 AND [DueDate] IS NOT NULL");
