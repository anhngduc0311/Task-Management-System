...
namespace TaskManagement.Application.DTOs.Inventory
{
    public class ExportReceiptDto
    {
        ...
        public List<ExportReceiptLineDto> Lines { get; set; } = new List<ExportReceiptLineDto>();
    }
    ...
    public class CreateExportReceiptDto
    {
        ...
        public List<CreateExportReceiptLineDto> Lines { get; set; } = new List<CreateExportReceiptLineDto>();
    }

    public class CreateExportReceiptLineDto
    {
        [Required]
        public Guid ProductId { get; set; }
        public Guid? ProductVariantId { get; set; }
